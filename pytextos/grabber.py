...
def scrape(url_list):
    """ Takes a list of URLs and scrapes title, body text and source URL, all
        saved as txt file"""
    user_agent = (
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Saves title and text from URLs to a text file"
    )
    # Required positional argument
    parser.add_argument(
        "--manual",
        help="Takes a number of URLs to be entered manually (default 1)",
        default=1,
        type=int,
    )
